...
public class TetrisTests {
    ...
    @Test
    void testComputeNextRotation(){
        TetrisPiece piece = new TetrisPiece("0 0  1 0  2 0  0 1");
        TetrisPiece piece2 = new TetrisPiece("0 2  0 1  0 0  1 2");
        TetrisPiece piece3 = piece.computeNextRotation();

        assertEquals(piece3,piece2);
    }

    @Test
    void testMakeFastRotations() {
        TetrisPiece piece = new TetrisPiece(TetrisPiece.S2_STR); //s2
        piece = TetrisPiece.makeFastRotations(piece);
        TetrisPiece piece2 = new TetrisPiece(TetrisPiece.STICK_STR);
        piece2 = TetrisPiece.makeFastRotations(piece2);
    ...
    void testEquals() {
        ...
        TetrisPiece pieceB = new TetrisPiece("1 1  1 0  1 2  0 1");
    ...
    void testPlacePiece() {
        ...
        board.commit();
        retval = board.placePiece(pieceA, 0,0);board.undo();
